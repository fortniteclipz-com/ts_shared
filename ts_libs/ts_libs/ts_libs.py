...
def init():
    ...
    logger.info("init | info", environ=os.environ, optdir=os.listdir("/opt"), optbindir=os.listdir("/opt/bin"), optlibdir=os.listdir("/opt/lib"), opttessdatadir=os.listdir("/opt/tessdata"))
