...
def save_clip_segments(clip_segments):
    ...
    try:
        ...
        logger.error("save_clip_segments | error", traceback=''.join(traceback.format_tb(e.__traceback__)))
...
def get_clip_segments(clip_id):
    ...
    try:
        ...
        logger.error("get_clip_segments | error", traceback=''.join(traceback.format_tb(e.__traceback__)))
        return []
...
def get_clips_segments(clip_ids):
    ...
    try:
        ...
        logger.error("get_clips_segments | error", traceback=''.join(traceback.format_tb(e.__traceback__)))
        return []
