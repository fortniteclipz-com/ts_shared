...
def save_montage_clips(montage_clips):
    ...
    try:
        ...
        logger.error("save_montage_clips | error", traceback=''.join(traceback.format_tb(e.__traceback__)))
...
def get_montage_clips(montage_id):
    ...
    try:
        ...
        logger.error("get_montage_clips | error", traceback=''.join(traceback.format_tb(e.__traceback__)))
        return []
